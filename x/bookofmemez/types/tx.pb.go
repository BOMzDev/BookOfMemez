...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_949f3e7f9ca606d6, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_949f3e7f9ca606d6, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "bookofmemez.bookofmemez.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "bookofmemez.bookofmemez.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("bookofmemez/bookofmemez/tx.proto", fileDescriptor_949f3e7f9ca606d6) }

var fileDescriptor_949f3e7f9ca606d6 = []byte{
	// 328 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0xca, 0xcf, 0xcf,
	0xce, 0x4f, 0xcb, 0x4d, 0xcd, 0x4d, 0xad, 0xd2, 0x47, 0x66, 0x97, 0x54, 0xe8, 0x15, 0x14, 0xe5,
	...
	0x6e, 0x3c, 0x96, 0x63, 0x88, 0x92, 0x77, 0xca, 0xcf, 0xcf, 0xf6, 0x4f, 0xf3, 0xc5, 0xe2, 0xb3,
	0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0x24, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x5e, 0xe2, 0x71, 0x0f, 0x64, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bookofmemez.bookofmemez.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bookofmemez.bookofmemez.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bookofmemez.bookofmemez.Msg",
	...
	Metadata: "bookofmemez/bookofmemez/tx.proto",
}
